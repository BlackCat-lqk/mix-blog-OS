    ...
    >
      <div class="header">
        <button type="button" class="back-icon" aria-label="收起播放页" @click="handleClose">
          <img src="@/assets/iMusic/icons/down.svg" alt="" />
        </button>
      ...
      <div class="control-box">
        <div class="control-item-box">
          <div class="add-box">
            <img src="@/assets/iMusic/icons/addWhite.svg" @click="addToFavorites" />
          </div>
          <div
            class="shuffle"
            ...
            @click="toggleShuffle"
          >
            <img src="@/assets/iMusic/icons/shuffle.svg" />
          </div>
          <div @click="prviousSong">
            <img src="@/assets/iMusic/icons/previousSong.svg" />
          </div>
          <div class="play-box" @click="togglePlay">
            <img :src="isPlaying ? SuspendIcon : PlayIcon" />
          </div>
          <div @click="nextSong">
            <img src="@/assets/iMusic/icons/nextSong.svg" />
          </div>
          <div class="repeat" :class="{ 'mode-active': isSingleLoop }" @click="loopControl">
            <img v-if="!isSingleLoop" src="@/assets/iMusic/icons/repeat.svg" />
            <img v-else src="@/assets/iMusic/icons/repeatOnce.svg" />
          </div>
          <div class="like-box">
            <img v-if="!likesFlase" src="@/assets/iMusic/icons/likeWhite.svg" @click="addToLikes" />
            <img v-else src="@/assets/iMusic/icons/like.svg" @click="removeLikes" />
          </div>
        </div>
      </div>
...
import defaultCoverImg from "@/assets/iMusic/images/music.webp";
